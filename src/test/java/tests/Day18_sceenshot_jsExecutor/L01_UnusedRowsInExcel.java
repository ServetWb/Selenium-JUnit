...
public class L01_UnusedRowsInExcel {
    ...
    public void test01() throws IOException, FileNotFoundException {
        ...
        Sheet sheet2 = workbook.getSheet("Sayfa2"); // "Sayfa2" means "Sheet2"
        ...
        double actualValue = sheet2.getRow(3).getCell(0).getNumericCellValue(); // 4th row (index 3), 1st column (index 0)
